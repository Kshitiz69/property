...
class ManageListingController extends BaseController
{
    public function __construct()
    {
        $this->title = 'Manage Listings';
        $this->resources = 'user.mrental.';
        $this->route = "manage-listings.";
        parent::__construct();
    }
    ...
    {
        $info = $this->crudInfo();
        $info['route'] = 'manage-listings.';
        $info['listings'] = Listing::where('user_id', auth()->user()->id)->where('type', 'rent')->get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manage-listings.index')->with('success', 'Listing Saved Successfully!.');
    }
